...
(function() {
  var AScene, Bezier, BubbleManager, Building, BuildingFactory, Castle, CastleConditionChecker, ConstructionArea, Country, CubicBezier, DisplayController, Game, GameScene, HitTest, InteractiveController, King, LineCreation, LineGBox, LoadScene, Main, Map, Mine, Mobile, MobileFactory, Point, SceneTraveler, ShapeCreation, Soldier, StartScene, StoryManager, TAN_HALF_PI, Test01, TileFlag, add, angle, angle_between, average, delta, findCorner, isSquare, isTriangle, len, vector,
  ...
  Castle = (function(_super) {
    ...
    Castle.prototype.unitDuration = 1000;
    ...
    function Castle(owner) {
      Castle.__super__.constructor.call(this, owner, PIXI.Texture.fromImage("./img/castle_A.png"));
  ...
  ConstructionArea = (function(_super) {
    ...
    function ConstructionArea() {
      ConstructionArea.__super__.constructor.call(this, PIXI.Texture.fromImage("./img/empty_s.png"));
      this.anchor.x = .5;
      this.anchor.y = .5;
      return;
    }
  ...
  InteractiveController = (function() {
    ...
    InteractiveController.prototype.onTouch = function(data) {
      ...
      if (area !== null) {
        if (area.building === null && Game.instance.canConstruct) {
  ...
  Mobile = (function(_super) {
    ...
    Mobile.prototype.position = null;

    Mobile.prototype.owner = null;

    Mobile.prototype.line = null;

    Mobile.prototype.sprite = null;

    Mobile.prototype.isWaiting = false;

    function Mobile(texture, line, owner) {
      if (line == null) {
        line = [];
      }
      this.owner = owner != null ? owner : Country.Dots;
      this.line = [];
      Mobile.__super__.constructor.call(this, texture);
      return;
    }
  ...
  */
  ...
  Mine = (function() {
    ...
    function Mine(owner) {
      ...
      Mine.__super__.constructor.call(this, owner, texture);
  ...
  StoryManager = (function() {
    ...
    StoryManager.prototype.init = function() {
      this.steps = [this.buildCastleStep, this.buildCastleSucessStep, this.ennemyVillageStep, this.moveYourUnitStep, this.winFirstBattleStep];
    };
  ...
  Soldier = (function(_super) {
    ...
    function Soldier() {
      Soldier.__super__.constructor.call(this, new PIXI.Texture.fromImage("./img/soldier_dot_S.png", null));
    }
